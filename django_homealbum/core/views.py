...
def photo_by_tag(request, tag_name, photo_hash):
    ...
    context = {
        ...
        'raw_url': pic_mediafile.get_raw_url(),
        'raw_settings_url': pic_mediafile.get_raw_settings_url(),
        'up_url': up_url,
    ...
    return render(request, 'core/photo.html', context)
...
def photo_by_album(request, album_name, albumitem_id):
    ...
    context = {
        ...
        'raw_url': album_item.get_raw_url(),
        'raw_settings_url': album_item.get_raw_settings_url(),
        'up_url': up_url,
