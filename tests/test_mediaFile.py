...
from mopho.models import MediaFile, MEDIATYPE_PHOTO, AlbumItem, Album, MediaFileTag, Tag, MediaFileComment
...
class TestMediaFile(TestCase):
    ...
    def test_transfer_relations_to_other(self):
        ...
        self.assertEqual(self.m1.mediafiletag_set.count(), 1)
        self.assertEqual(self.m1.mediafilecomment_set.count(), 1)
        self.assertEqual(self.m2.albumitem_set.count(), 0)
        self.assertEqual(self.m2.mediafiletag_set.count(), 0)
        self.assertEqual(self.m2.mediafilecomment_set.count(), 0)
        self.m1.transfer_relations_to_other(self.m2)
        self.assertEqual(self.m1.albumitem_set.count(), 0)
        self.assertEqual(self.m1.mediafiletag_set.count(), 0)
        self.assertEqual(self.m1.mediafilecomment_set.count(), 0)
        self.assertEqual(self.m2.albumitem_set.count(), 1)
        self.assertEqual(self.m2.mediafiletag_set.count(), 1)
        self.assertEqual(self.m2.mediafilecomment_set.count(), 1)
